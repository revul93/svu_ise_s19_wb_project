...
CREATE TABLE [dbo].[Donation] (
    ...
    CONSTRAINT [Fk_Donation_Plan] FOREIGN KEY ([plan_id]) REFERENCES [dbo].[Plan] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT [Fk_Donation_Donor] FOREIGN KEY ([donor_id]) REFERENCES [dbo].[Donor] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE
);